...
import { throttle } from './commonUtils';
...
export const useTabActive = ({ throttleDelay = 0 } = {}) => {
  ...
  useEffect(() => {
    document.addEventListener(
      'visibilitychange',
      throttleDelay ? throttle(handleVisibilityChange, throttleDelay) : handleVisibilityChange,
    );
    return () => {
