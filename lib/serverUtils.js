...
import { getFullName, getFullTrickName, populateComboName, populateComboTrickName, sOrNoS } from './commonUtils';
...
export const ensureProfile = async (query) =>
  await Profile.findOneAndUpdate(query, {}, { new: true, upsert: true, timestamps: false });
