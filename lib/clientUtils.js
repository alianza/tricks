  ...
  const defaultActions = [
    {
      edit: (obj) => (
        <Link
          ...
          className={`${button} ${green} -md:!p-1 -md:ring-inset !rounded-none md:!rounded`}
        >
          Edit
        </Link>
      ),
    },
    {
      view: (obj) => (
        <Link
          ...
          className={`${button} ${blue} -md:!p-1 -md:ring-inset !rounded-none md:!rounded`}
        >
          View
        </Link>
      ),
    ...
    {
      delete: () => (
        <button className={`${button} ${red} -md:!p-1 -md:ring-inset !rounded-none md:!rounded`}>Delete</button>
      ),
    },
  ];
