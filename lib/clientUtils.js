 ...
 * @param router {NextRouter} - The Next.js router object
 * @returns {*}
 */
export const triggerLoader = (router) => {
  const params = new URLSearchParams(router.query);
  return router.push({ pathname: router.pathname, query: params.toString() }, undefined, { shallow: true });
};
